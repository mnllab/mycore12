 ...
 * 운영 문항은행 (v3.2).
 *
 * v3.1 대비 144문항 전체의 scenario / optionA / optionB 를 쉬운 문장으로 윤문했고,
 * id · axis · context · optionAValue · optionBValue · responseScale · active 는
 * 전부 동일하다 (변경 이력: positive_question_bank_changelog_v3.2.json). 따라서
 * 추출(drawAssessment)·채점(scoreAssessment) 결과는 v3.1 과 완전히 같다.
 * 엔진은 원본 v3.1 모듈을 그대로 사용하고, 화면과 문항 조회는 이 v3.2 를 사용한다.
 */
